...
<section class="service-section">
  <div class="container">
    <div class="servce-head"  data-aos="fade-up" data-aos-duration="1500">
      <h3>Innovative Solutions, Unmatched Quality</h3>
      <p>At Arab Graphics, explore our diverse range of printing and advertising services tailored to 
        meet your every need which includes:</p>
    </div>

   <div class="main-services">
    <div class="row d-flex align-items-center"  data-aos="fade-right" data-aos-duration="1500"> 
      <div class="col-lg-5">
        <div class="srvce-dtl-img">
          <img src="assets/img/printing-serv/offset.png" alt="" class="img-fluid">
        </div>
      </div> 
   ...
   <div class="main-services">
    <div class="row d-flex align-items-center"> 
      <div class="col-lg-5"  data-aos="fade-right" data-aos-duration="1500">
        <div class="srvce-dtl-img">
          <img src="assets/img/printing-serv/speciality.png" alt="" class="img-fluid">
        </div>
      </div> 
      <div class="col-lg-7"  data-aos="fade-left" data-aos-duration="1500">
        <div class="srvce-dtl-cntns">
   ...
   <div class="main-services">
    <div class="row d-flex align-items-center"> 
      <div class="col-lg-5" data-aos="fade-right" data-aos-duration="1500">
        <div class="srvce-dtl-img">
          <img src="assets/img/printing-serv/uv.png" alt="" class="img-fluid">
        </div>
      </div> 
      <div class="col-lg-7"  data-aos="fade-left" data-aos-duration="1500">
        <div class="srvce-dtl-cntns">
      ...
      <div class="col-lg-7 order-2 order-md-1"  data-aos="fade-right" data-aos-duration="1500">
        <div class="srvce-dtl-cntns">
          ...
          <p> Our sublimation printing services allow for the transfer of vibrant, 
            full-color designs onto polyester-based materials, such as apparel, mugs, and Lanyards T
